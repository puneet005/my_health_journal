...
ProceduresBottomSheet(BuildContext context, CalendarModelData? data){
            ...
            child: Row(
                  ...
                  children: [           
                          ...
                          //  ),
                            ...
                            //  addHeight(20),
                             addBoldTxt("${data.type ?? ""}", fontSize: 20, ).paddingOnly(
                              bottom: 6.h
                            ),

                            Row(
                              children: [
                               addRegularTxt("${data.dateOfProcedure ?? ""}  ${data.visitTime ?? ""}", color: AppColors.greyColor4, fontSize: 12),
