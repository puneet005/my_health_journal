...
class AddPersonalHistory extends StatefulWidget {
  const AddPersonalHistory({super.key});

  @override
  State<AddPersonalHistory> createState() => _AddPersonalHistoryState();
}

class _AddPersonalHistoryState extends State<AddPersonalHistory> {
  @override
                      ...
                      child: InkWell(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            addHeadingTxtMedium("Add Personal History", fontSize: 15.sp,  color: AppColors.blackColor, fontFamily: "Montserrat-medium" ),
                ...
                Padding(
                          ...
                          horizontal: 8.h
                              ...
                              child: Column(
                                children: [
                                 TextFormField(                              
                                    maxLines: 5,
                                    controller: ctrl.personalHistoryComment,
                                    validator: (val){
                                    if(val!.isEmpty){
                 ...
                 Padding(
                  ...
                  child:   CustomButton(
                    ...
                    width: Get.width / 2,
                    text: "Save", onPressed: (){
                      if(ctrl.personalHistoryForm.currentState!.validate()){
