...
class PersonalHistoryListUi extends StatefulWidget {
  const PersonalHistoryListUi({super.key});

  @override
  State<PersonalHistoryListUi> createState() => _PersonalHistoryListUiState();
}

class _PersonalHistoryListUiState extends State<PersonalHistoryListUi> {
  final bottomCont = Get.find<BottomBarController>();
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    bottomCont.getBothHistoryListApi(false);
  }
  @override
                  ...
                  width: double.infinity,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            addHeight(50.h),
                            AppBar1(title: "Personal History", notificationIcon: false,),
                            addHeight(16.h),
                            SelectPatientCard(route: AppRoutes.addPersonalHistory),
                            Expanded(child: 
                             ...
                             ListView(
                              ...
                              children: List.generate(bottomCont.personalHistoryList!.length, (index) {
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [                                    
                                        addRegularTxt(bottomCont.personalHistoryList![index].comment ?? "", fontSize: 14.h),                                                                  
                                      ],
                                    ),
                                  ),
                                ),
