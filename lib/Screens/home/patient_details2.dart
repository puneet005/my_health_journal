...
class _PatientDetails2State extends State<PatientDetails2> {
  ...
  void initState() {
    ...
    //   cont.downloadpercent.value = 0;
    //   cont.update();
    //   TestDialog(true);
    //   });
    // Future.delayed(Duration(seconds: 2), () {
    //   cont.downloadpercent.value= 25;
    //   cont.update();
    // });
    // Future.delayed(Duration(seconds: 4), () {
    //   cont.downloadpercent.value= 50;
    //   cont.update();
    // });
    // Future.delayed(Duration(seconds: 6), (){
    //  cont.downloadpercent.value= 75;
    //   cont.update();
    // });
    // Future.delayed(Duration(seconds: 8), () {
    //   cont.downloadpercent.value= 100;
    //   cont.update();
    // });
    // Future.delayed(Duration(seconds: 10), () => TestDialog(false));
  }
                      ...
                      children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              image: bottomCont.selectedPatient
                                                          .profile !=
                                                      null
                                                  ? NetworkImage(
                                                      "${ApiUrls.domain}${bottomCont.selectedPatient.profile}")
                                                  : AssetImage(AppAssets.patient1)
                                                      as ImageProvider,
                                              fit: BoxFit.cover)),
                                ...
                                Column(
                                  ...
                                  children: [
                                    addBoldTxt(
                                        bottomCont.selectedPatient.name ?? "",
                                        fontSize: 16),
                                    addBoldTxt(
                                        bottomCont.selectedPatient.relation ?? "",
                                        fontSize: 12,
                        ...
                        AnimationLimiter(
                          child: GridView.count(
                              ...
                              //
                              children: List.generate(ctrl.listofCatagory2.length,
                                  (index) {
                        ...
                        CustomButton(
                            width: Get.width,
                            height: 60,
                            text: "Full Medical Summary",
                            onPressed: () {
                              ctrl.FullMedicalSummaryApi();
                            }),
                        addHeight(30),
                      ],
                    ),
