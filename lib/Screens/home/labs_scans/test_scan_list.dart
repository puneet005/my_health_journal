...
class TestScansListUi extends StatefulWidget {
  const TestScansListUi({super.key});

  @override
  State<TestScansListUi> createState() => _TestScansListUiState();
}

class _TestScansListUiState extends State<TestScansListUi> {
final bottomCont = Get.find<BottomBarController>();
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    bottomCont.getTestScanListApi();
  }
  @override
                  ...
                  width: double.infinity,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            addHeight(50.h),
                            AppBar1(title: "Tests and Scans", notificationIcon: false,),
                            addHeight(16.h),
                            SelectPatientCard(route: AppRoutes.addTestScan),
                            Expanded(child: 
                             ...
                             ListView(
                              ...
                              children: List.generate(bottomCont.testScanList!.length, (index) {
                            ...
                            child:  Padding(
                              ...
                              child: InkWell(
                                onTap: (){
                                  ...
                                  Get.to(TestScansDetailsView(data: bottomCont.testScanList![index]));
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(children: [
                                      bottomCont.testScanList![index].file != null  ?                                 
                                       BaseImageNetwork(
                                      fit: BoxFit.cover,
                                      borderRadius: 40,
                                      link: "${ApiUrls.domain}${bottomCont.testScanList![index].file}",
                                      concatBaseUrl: true,
                                      isAssetImage: false,
                                      height: 60.h,
                                      width: 60.h,
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            addRegularTxt("${bottomCont.testScanList![index].name ?? ""}", fontSize: 16.h),
                                            addHeadingTxtMedium("${bottomCont.testScanList![index].scanTest ?? ""}", fontSize: 14, fontFamily: 'Montserrat-light'),
