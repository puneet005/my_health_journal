...
class ProceduresAddComment extends StatefulWidget {
  String id;
   ProceduresAddComment({super.key, required this.id});
  @override
  State<ProceduresAddComment> createState() => _ProceduresAddCommentState();
}
class _ProceduresAddCommentState extends State<ProceduresAddComment> {
          ...
          body:  GetBuilder<HomeController>(  
            ...
            builder: (ctrl) {
              return Container(
                  ...
                  child:   Form(
                    key: ctrl.proceduresAddCommentForm,
                    child: Padding(
                      ...
                      child: ListView(
                              ...
                              Padding(
                                ...
                                horizontal: 8.h
                                    ...
                                    child: Column(
                                      children: [
                                         TextField( 
                                          controller: ctrl.proceduresAddComment,                       
                                          maxLines: 5,
                       ...
                       Padding(
                        ...
                        child:   CustomButton(
                          ...
                          width: Get.width / 2,
                          text: "Save", onPressed: (){
                            if(ctrl.proceduresAddCommentForm.currentState!.validate()){
                              ctrl.ProceduresAddCommentApi(todayDate.toString(), widget.id );                  
                            }
                          }),
                      ),
