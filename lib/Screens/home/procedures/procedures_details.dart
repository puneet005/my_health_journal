...
class ProceduresDetailsView extends StatefulWidget {
  ProceduresListModelData? data;
   ProceduresDetailsView({super.key, required this.data});

  @override
  State<ProceduresDetailsView> createState() => _ProceduresDetailsViewState();
}

class _ProceduresDetailsViewState extends State<ProceduresDetailsView> {
  @override
                 ...
                 Positioned(
                    ...
                    Positioned(
                      ...
                      child: Padding(
                        ...
                        child: ListView(
                          children: [
                          addBoldTxt("${widget.data!.type ?? ""}", fontSize: 20, ).paddingOnly(
                              bottom: 6.h
                            ),

                            Row(
                              children: [
                               addRegularTxt("${widget.data!.dateOfProcedure ?? ""}", color: AppColors.greyColor4, fontSize: 12),
                         ...
                         InkWell(
                          onTap: (){
                           Get.to(ProceduresAddComment(id: widget.data!.id.toString()));
                          },
                           child: CircleAvatar(
                            radius: 15.h,
