                    ...
                    Padding(
                      ...
                      child: Container(                 
                              ...
                              horizontal: 8.h
                                  ...
                                  child: Column(
                                    children: [
                                     TextFormField(                              
                                        maxLines: 5,
                                        controller: ctrl.symptomComment,
                                        validator: (val){
                                        if(val!.isEmpty){
                        ...
                        return null;
                                  ...
                                  size: 16.h,)
                                  ,addWidth(10),
                                  addRegularTxt("${time}", color: AppColors.orangeColor3, fontSize: 13.sp), 
                                  addWidth(10),
                                                      ],
                                                    ),
                                                  ),
                     ...
                     Padding(
                      ...
                      child:   CustomButton(
                        ...
                        text: "Continue", onPressed: (){
                          if(ctrl.symptomsForm.currentState!.validate()){
                            ctrl.AddSymptomsApi(todayDate!, time!);
                          } 
                        }),
                    ),
                    //  addHeight(10),
